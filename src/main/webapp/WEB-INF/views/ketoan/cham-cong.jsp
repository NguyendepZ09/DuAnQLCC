...
<head>
    ...
    <title>Chấm Công Của Tôi — PolyBuilding Kế Toán</title>
    ...
    <div class="content-body">
        ...
        <div class="card-custom mb-4">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <div class="d-flex align-items-center gap-3 flex-wrap">
                    <!-- Form Chấm Công Vào -->
                    <form action="${pageContext.request.contextPath}/ketoan/cham-cong/ghi" method="post" class="d-flex align-items-center gap-2">
                    ...
                    <!-- Form Chấm Công Ra -->
                    <form action="${pageContext.request.contextPath}/ketoan/cham-cong/ghi" method="post" class="d-inline">
        ...
        <div class="card-custom">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <form action="${pageContext.request.contextPath}/ketoan/cham-cong" method="get" class="d-flex align-items-center gap-2">
