...
<head>
    ...
    <style>
        ...
        .error-card { background: #FFF; padding: 40px; border-radius: 16px; border: 1px solid #DCE6E0; box-shadow: 0 8px 24px rgba(0,0,0,0.06); text-align: center; max-width: 480px; width: 90%; }
