...
<div class="container-box">
    ...
    <h3 class="fw-bold text-dark mb-2">Phân Hệ Bảo Vệ Đang Phát Triển</h3>
    <p class="text-muted mb-4">
        Các tính năng quản lý tuần tra, đăng ký xe và kiểm soát an ninh dành cho Bộ Phận Bảo Vệ sẽ ra mắt trong phiên bản tới.
    </p>
