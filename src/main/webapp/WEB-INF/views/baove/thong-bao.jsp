...
<head>
    ...
    <title>Thông Báo - PolyBuilding Bảo Vệ</title>
</head>
<body>
                                ...
                                <div class="card shadow-sm border-0 ${!tb.daDoc ? 'border-start border-4 border-warning bg-light-subtle' : ''}">
                                    <div class="card-body p-3">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center pt-2 border-top">
                                            <small class="text-muted">👤 Người gửi: <strong class="text-dark"><c:out value="${tenNguoiGui}" /></strong></small>
                                            <c:choose>
                                                <c:when test="${!tb.daDoc}">
                                                    <form method="POST" action="${pageContext.request.contextPath}/baove/thong-bao/da-doc" class="m-0">
