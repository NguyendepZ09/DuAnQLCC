        ...
        <div class="card-custom mb-4">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <div class="d-flex align-items-center gap-3 flex-wrap">
                    <!-- Form Chấm Công Vào -->
                    <form action="${pageContext.request.contextPath}/letan/cham-cong/ghi" method="post" class="d-flex align-items-center gap-2">
                    ...
                    <!-- Form Chấm Công Ra -->
                    <form action="${pageContext.request.contextPath}/letan/cham-cong/ghi" method="post" class="d-inline">
