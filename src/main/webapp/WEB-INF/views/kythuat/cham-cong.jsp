...
<head>
    ...
    <title>Chấm Công Của Tôi — PolyBuilding Kỹ Thuật</title>
...
<jsp:include page="/WEB-INF/views/kythuat/common/sidebar.jsp" />

<div class="main-wrapper">
    <jsp:include page="/WEB-INF/views/kythuat/common/header.jsp" />
    ...
    <div class="content-body">
        ...
        <div class="card-custom">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <form action="${pageContext.request.contextPath}/kythuat/cham-cong" method="get" class="d-flex align-items-center gap-2">
