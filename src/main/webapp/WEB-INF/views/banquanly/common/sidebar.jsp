...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="${pageContext.request.contextPath}/banquanly/nhan-su" class="nav-item <%= currentUri.contains("nhan-su") ? "active" : "" %>">
        ...
        <a href="${pageContext.request.contextPath}/banquanly/qr-tuan-tra" class="nav-item <%= currentUri.contains("qr-tuan-tra") ? "active" : "" %>">
