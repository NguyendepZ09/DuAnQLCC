...
<div class="shell">
  ...
  <aside class="aside">
    <div>
      <a href="${pageContext.request.contextPath}/index.jsp" class="brand" id="asideBrand">
        <span class="mark"></span>POLYBUILDING
      </a>
      <a href="${pageContext.request.contextPath}/index.jsp" class="back-link" id="asideBackLink">
