...
public class ThongKeDAO {
    ...
    /**
     * 1. Query: SELECT trangThaiThanhToan, SUM(tongTien) FROM hoaDon GROUP BY trangThaiThanhToan
     */
    ...
    /**
     * 2. Query: SELECT trangThai, COUNT(*) FROM phanAnhSuCo GROUP BY trangThai
     */
    ...
    /**
     * 3. Query JOIN nhanVien va lichSuXuLySuCo lay ten nhan vien co so ca xu ly nhieu nhat
     */
